...
class DocumentationConsistencyValidator:
    ...
    def _validate_roadmap_status_consistency(
        ...
        roadmap_path = self._repository_root / "docs/platform/Implementation_Roadmap.md"
        status_path = self._repository_root / "docs/platform/Implementation_Status.md"
        ...
        if not roadmap_phases:
            issues.append(
                ValidationIssue(
                    ...
                    repository_path="docs/platform/Implementation_Roadmap.md",
                )
            )
            return issues
        ...
        if not status_phases:
            issues.append(
                ValidationIssue(
                    ...
                    repository_path="docs/platform/Implementation_Status.md",
                )
            )
            return issues
