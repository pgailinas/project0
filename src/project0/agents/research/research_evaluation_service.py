    ...
    def _build_provider_request(
        ...
        return ProviderRequest(
            system_instructions=(
                ...
                "Keep three judgments separate: (1) methodological "
                "relevance of the demonstrated learning objective or "
                "representation mechanism, (2) direct applicability to "
                "the requested task, dataset, and existing baseline, and "
                "(3) experimental feasibility under the user's stated "
                "compute and implementation constraints. The relevance "
                "score and mechanism_match measure the first judgment "
                "using the evidence-based bands above; missing evidence "
                "of a target-dataset evaluation, released checkpoint, "
                "runtime, or small-compute implementation must not by "
                "itself lower the mechanism classification. Conversely, "
                "do not treat methodological relevance as proof of "
                "direct applicability or feasibility. In "
                "research_connections, describe the demonstrated "
                "mechanism and a specific proposed adaptation to the "
                "request's setting, explicitly distinguishing proposed "
                "work from experiments reported by the paper. In "
                "limitations, separately identify any missing evidence "
                "about direct task or baseline evaluation and any "
                "unverified compute, checkpoint, training, or data "
                "requirements when these matter to the request. If "
                "feasibility is not established by supplied evidence, "
                "say it is unverified rather than claiming that a "
                "Colab-scale experiment is feasible or infeasible. "
                "Avoid generic claims that a method can simply be "
                "integrated with a baseline; specify the feature, "
                "objective, or encoder interface that would need to "
                "change when evidence permits. Do not invent compute "
                "costs, checkpoints, datasets, or experimental results. "
