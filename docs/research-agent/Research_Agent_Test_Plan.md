...
Verify provider normalization, Semantic Scholar fallback, canonical fallback-seed title enrichment from usable embedded PDF metadata without overwriting provider titles, rejection of generic or malformed PDF titles, abstract evidence, PDF/type validation, page-preserving section extraction, eight-paper and 24,000-character limits, discovery-only state, preliminary ranking, three-paper batches, opaque IDs, integer 0–100 normalization, high-score transfer checks, internally consistent deterministic mechanism corrections, removal of contradicted connections and limitations, preservation of unrelated limitations, partial recovery plus one retry, exact one-point post-retry boundary correction with warning and full revalidation, rejection of larger score-band contradictions, persistent unscored defects, threshold-independent evidence retention, score ordering, and Maximum Results.
